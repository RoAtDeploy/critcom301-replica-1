...
Deno.serve(async (req) => {
  try {
    ...
    const { transcription, staffName, role, callType, callDate, context, staffChannel, otherRole } = await req.json();
    ...
    const report = {
      ...
      staffChannel: staffChannel || null,
