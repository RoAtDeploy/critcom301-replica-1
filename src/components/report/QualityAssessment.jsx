...
const GRADE_CONFIG = {
  A: { label: "A", color: "bg-emerald-100 text-emerald-700 border-emerald-300", dot: "bg-emerald-500", description: "NO ACTION REQUIRED", tooltip: "High standard of communications: communications protocols followed and evidence of effective non-technical skills such as planning the communication, being clear and concise, challenging where appropriate and actively listening to understand." },
  B: { label: "B", color: "bg-yellow-100 text-yellow-700 border-yellow-300", dot: "bg-yellow-500", description: "FEEDBACK REQUIRED", tooltip: "Competent with Development: satisfactory performance but could be improved. Most protocols followed. Satisfactory evidence of summarising, questioning, and repeating back to check understanding." },
  C: { label: "C", color: "bg-orange-100 text-orange-700 border-orange-300", dot: "bg-orange-500", description: "DAP REQUIRED", tooltip: "Medium Risk: performance gives rise to concerns. Some protocols followed but with significant variations and possibility of misunderstanding. Limited or poor non-technical skills such as clarity, listening, questioning and summarising." },
  D: { label: "D", color: "bg-red-100 text-red-700 border-red-300", dot: "bg-red-500", description: "IMMEDIATE ACTION REQUIRED", tooltip: "High Risk: communications not acceptable. None or very limited attempt to follow communications protocols. Poor or absent non-technical skills resulting in safety being compromised." },
